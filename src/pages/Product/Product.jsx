...
const Product = () => {
    ...
    const { id, thumbnail, price, title, rating, description } = product || {};
    ...
    <div className='p-8 md:p-10'>
       <div className="flex flex-col md:flex-row items-center justify-center">
            <div className='w-full lg:w-2/4'>
                <a href="#">
                    <img className="p-5 w-full h-72 md:h-96" src={thumbnail} alt="product image" />
                </a>
            </div>
            <div className="px-5 pb-5 w-full lg:w-2/4">
                <a href="#">
                    <h5 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{title}</h5>
                    <p className='font-normal my-3'>{description}</p>
                </a>
